...
class PerfomanceAdapter(private val perfomances: List<Perfomance>) :
    RecyclerView.Adapter<PerfomanceAdapter.PerfomanceViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PerfomanceViewHolder, position: Int) {
        holder.view.date_view_perfomance.text = perfomances[position].date
